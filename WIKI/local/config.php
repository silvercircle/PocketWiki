...
$EnablePathInfo = 1;
$ScriptUrl = "http://wiki.miranda.or.at";
...
function GenerationTime(){
	...
	//print '<div><center><span style="font-size:10px;">Page generation time: '. $GenerationTotal.' seconds</span></center></div>';
}
			
$DefaultPasswords['admin'] = crypt('rayuela');
$DefaultPasswords['edit'] = '@admins'; 
$DefaultPasswords['history'] = '@admins';
...
$EnableDrafts = 1;
$DiffKeepDays = 30;
$PageListCacheDir = 'cache.d/lists';
$EnablePageIndex=1;
...
$FastCacheInvalidateAllOnUpdate=FALSE;
...
SDV($MarkupExtensionsFmt, array("`f aquo '/ '@ '; [^ q&a A; {|} {= :: para")); 

$MarkupCss = true;
include_once("$FarmD/cookbook/extendmarkup.php");
$EnablePageBreaks=1;
// include_once("$FarmD/cookbook/quicktoc.php");
include_once("$FarmD/cookbook/toggle.php");

$Mailform4['recipient'] = 'silvercircle@gmail.com'; //the address the contact form output will be sent to
$Mailform4['subject'] = 'Message from Wiki formmailer';
...
$Mailform4ValidFields = array(
    ...
    'subject' => array('string', 3, null)
);
      
include_once("$FarmD/cookbook/mailform4.php");

$Array_Syntaxlove = 
       array("Bash"   => "0", "CSharp" => "0", "Css"     => "1", "Delphi" => "0",
             "Groovy" => "0", "Java"   => "0", "JScript" => "0", "Perl"   => "0",
	     "Php"    => "1", "Plain"  => "0", "Python" => "0",  "Ruby"   => "0", 
	     "Scala"  => "0", "Sql"    => "0", "Vb"     => "0",  "Xml"    => "0", "Cpp" => "1");
include_once("$FarmD/cookbook/syntaxlove.php");
